...
- 레지스터 이름은 문자열 또는 식별자 형태로 파싱할 수 있습니다.

입력 피연산자는 변수, 정수 리터럴, 문자열 리터럴, `&identifier`, `deref identifier`, 음수 숫자 등 이 릴리스의 asm 피연산자 파서가 처리하는 제한된 형태를 사용합니다.
...
- 메모리를 읽거나 쓰는 블록은 컴파일러가 알 수 있도록 필요한 clobber를 선언하십시오.
